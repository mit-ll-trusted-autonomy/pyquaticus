...
class USV(Dynamics):
    """
    Parameters for USV dynamics and control are adapted from MOOS-IVP software/docs:
        ...
        (2) https://oceanai.mit.edu/svn/moos-ivp-aro/trunk/ivp/src/dep_uSimMarine/uSimMarine.moos
            -max_speed
                *max(thrust_map[1]) + 0.5 buffer for normalization 
            -thrust_map
