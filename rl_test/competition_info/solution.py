...
class solution:
    ...
    def __init__(self):
        ...
        self.policy_one = Policy.from_checkpointPolicy.from_checkpoint(os.path.abspath('./working_dir/' + '<Your Policy Path Here>'))
        self.policy_two = Policy.from_checkpointPolicy.from_checkpoint(os.path.abspath('./working_dir/' + '<Your Policy Path Here>'))
        self.policy_three = Policy.from_checkpointPolicy.from_checkpoint(os.path.abspath('./working_dir/' + '<Your Policy Path Here>'))
