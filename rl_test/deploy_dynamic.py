...
"""
Run the trained blue policy from a checkpoint against random red agents.
...
def make_env(render_mode="human"):
    ...
    env = GraphObsWrapper(env, flatten_for_fc=False)  # GNN expects graph dict
...
def main():
    ...
    if not os.path.isdir(policy_path):
        ...
        print("Usage: python rl_test/deploy_dynamic.py [./ray_dynamic/iter_500]")
        return
