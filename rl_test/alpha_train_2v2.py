...
parser2 = add_rllib_example_script_args(
    default_iters=200,
...
if __name__ == '__main__':
    ...
    ret = run_rllib_example_script_experiment(base_config, args2)
    print("returns: ", ret, " OF Type: ", type(ret))


    # ppo_config = PPOConfig().api_stack(enable_rl_module_and_learner=False, enable_env_runner_and_connector_v2=False).environment(env='pyquaticus').env_runners(num_env_runners=1, num_cpus_per_env_runner=1.0)
